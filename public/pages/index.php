    ...
    <body>
                        ...
                        <div class="s-header-v2__navbar-col s-header-v2__navbar-col-width--180">
                            ...
                            <div class="s-header-v2__logo">
                                <a href="index.php" class="s-header-v2__logo-link">
                                    <img class="s-header-v2__logo-img s-header-v2__logo-img--default" width="150px" src="../img/logo-white.png" alt="Dublin Logo">
                                    <img class="s-header-v2__logo-img s-header-v2__logo-img--shrink" width="150px" src="../img/logo.png" alt="Dublin Logo">
                                </a>
                            </div>
                            <!-- End Logo -->
                        </div>
                        ...
                        <div class="s-header-v2__navbar-col s-header-v2__navbar-col--right">
                            ...
                            <div class="collapse navbar-collapse s-header-v2__navbar-collapse" id="nav-collapse">
                                <ul class="s-header-v2__nav">
                                    <li class="s-header-v2__nav-item"><a href="index.php" class="s-header-v2__nav-link">Acceuil</a></li>
                                    <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                        <a href="../javascript:void(0);" class="dropdown-toggle s-header-v2__nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">CREED <span class="g-font-size-10--xs g-margin-l-5--xs ti-angle-down"></span></a>
                                        <ul class="dropdown-menu s-header-v2__dropdown-menu">
                                            <li><a href="#missions" class="s-header-v2__dropdown-menu-link">Missions</a></li>
                                            <li><a href="creed.html#organisation" class="s-header-v2__dropdown-menu-link">Organisation</a></li>
                                            <li><a href="creed.html#financement" class="s-header-v2__dropdown-menu-link">Financement</a></li>
                                            <li><a href="creed.html#fondateurs" class="s-header-v2__dropdown-menu-link">Membres fondateurs</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                        <a href="../javascript:void(0);" class="dropdown-toggle s-header-v2__nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Recherche <span class="g-font-size-10--xs g-margin-l-5--xs ti-angle-down"></span></a>
                                        <ul class="dropdown-menu s-header-v2__dropdown-menu">
                                            <li><a href="orientation_strategique.html" class="s-header-v2__dropdown-menu-link">Orientations stratégiques</a></li>
                                            <li><a href="projet_parraine.html" class="s-header-v2__dropdown-menu-link">Projets parrainé</a></li>
                                            <li><a href="creed.html#financement" class="s-header-v2__dropdown-menu-link">Appels à projets</a></li>
                                            <li><a href="creed.html#fondateurs" class="s-header-v2__dropdown-menu-link">Règlementation de la recherche</a></li>
                                            <li><a href="creed.html#fondateurs" class="s-header-v2__dropdown-menu-link">Procédures de préparation des dossiers</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                        <a href="../javascript:void(0);" class="dropdown-toggle s-header-v2__nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Formation <span class="g-font-size-10--xs g-margin-l-5--xs ti-angle-down"></span></a>
                                        <ul class="dropdown-menu s-header-v2__dropdown-menu">
                                            <li><a href="creed.html#missions" class="s-header-v2__dropdown-menu-link">Orientations stratégiques</a></li>
                                            <li><a href="creed.html#organisation" class="s-header-v2__dropdown-menu-link">Projets parrainé</a></li>
                                            <li><a href="creed.html#financement" class="s-header-v2__dropdown-menu-link">Appels à projets</a></li>
                                            <li><a href="creed.html#fondateurs" class="s-header-v2__dropdown-menu-link">Règlementation de la recherche</a></li>
                                            <li><a href="creed.html#fondateurs" class="s-header-v2__dropdown-menu-link">Procédures de préparation des dossiers</a></li>
                                        </ul>
                                    ...
                                    <li class="dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover">
                                        <a href="../javascript:void(0);" class="dropdown-toggle s-header-v2__nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Publication <span class="g-font-size-10--xs g-margin-l-5--xs ti-angle-down"></span></a>
                                        <ul class="dropdown-menu s-header-v2__dropdown-menu">
                                            <li><a href="creed.html#missions" class="s-header-v2__dropdown-menu-link">Orientations stratégiques</a></li>
                                            <li><a href="creed.html#organisation" class="s-header-v2__dropdown-menu-link">Projets parrainé</a></li>
                                            <li><a href="creed.html#financement" class="s-header-v2__dropdown-menu-link">Appels à projets</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="g-margin-b-50--xs">
                                    <h1 class="g-font-size-32--xs g-font-size-45--sm g-font-size-60--md g-color--white">Veolia Environnement</h1>
                                    <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">Le Centre De Recherche CREED.</p>
                                </div>
                    ...
                    <div class="container g-text-right--xs g-ver-center--xs">
                        <div class="row">
                            <div class="col-md-7 col-md-offset-5">
                                <div class="g-margin-b-50--xs">
                                    <h2 class="g-font-size-32--xs g-font-size-45--sm g-font-size-55--md g-color--white">Veolia Environnement</h2>
                                    <p class="g-font-size-18--xs g-font-size-22--sm g-color--white-opacity">Le Centre De Recherche CREED.</p>
                                </div>
                                <a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50 g-padding-x-50--xs">Read More</a>
                            </div>
        ...
        <div class="g-hor-divider__dashed--sky-light g-padding-y-80--xs g-padding-y-125--xsm">
            <div class="container g-text-center--xs">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-50--xs">Mot du directeur</p>
                <div class="s-swiper js__swiper-testimonials">
                    <!-- Swiper Wrapper -->
                    <div class="g-margin-b-50--xs">
                        <div class="g-padding-x-130--sm g-padding-x-150--lg">
                            <div class="g-padding-x-20--xs g-padding-x-50--lg">
                                ...
                                <div class="g-margin-b-40--xs">
                                    <p class="g-font-size-22--xs g-font-size-28--sm g-color--heading"><i>" Mot du directeur. "</i></p>
                                </div>
                                <div class="center-block g-hor-divider__solid--heading-light g-width-100--xs g-margin-b-30--xs"></div>
                                <h4 class="g-font-size-15--xs g-font-size-18--sm g-color--primary g-margin-b-5--xs">Directeur / VEOLIA CREED</h4>
                            </div>
                        </div>
                    </div>
                    <!-- End Swipper Wrapper -->
        ...
        <div class="g-bg-color--sky-light">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-80--xs">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-letter-spacing--1">Les actualités du centre</h2>
                </div>
                <div class="row">
                    <div id="latest_news">
                    <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        ...
                        <article>
                            ...
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                ...
                                <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="article.html">Create Something Great.</a></h3>
                    ...
                    <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        ...
                        <article>
                            ...
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">News</p>
                                <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="article.html">Jacks of All. Experts in All.</a></h3>
                                <p>The time has come to bring those ideas and plans to life.</p>
                            </div>
                        </article>
                        <!-- End News -->
                    ...
                    <div class="col-sm-4">
                        ...
                        <article>
                            ...
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">News</p>
                                <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="article.html">Finding your Perfect Place.</a></h3>
                                <p>The time has come to bring those ideas and plans to life.</p>
                            </div>
                        </article>
                        <!-- End News -->
                ...
                <!-- LOAD NEW NEWS-->
                <div id="load_other_news" style="display: none">
                    <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="../img/970x970/01.jpg" alt="Image">
                ...
                <!-- LOAD NEW NEWS BUTTON -->
                <div id="load_more">
                    <center><button id="load_other_news_button" class="text-uppercase charger-plus s-btn s-btn-icon--md s-btn--primary-brd g-radius--50 g-padding-x-60--xs">
                        <span class="g-font-size-18--xs g-color--black ti-angle-double-down"><br>CHARGER PLUS</span>
                    </button></center>
                </div>
                <!-- END LOAD NEW NEWS BUTTON -->
                </div>
            </div>
        </div>
        <!-- Actualités V1 News -->
        ...
        <div class="container g-padding-y-100--xs">
            <center><p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-50--xs">Actualité du centre</p></center>
                    ...
                    <div class="row">
                        <div class="col-sm-2 g-margin-b-20--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes">Acceuil</a></li>
            ...
            <div class="container g-padding-y-50--xs">
                <div class="row">
                    ...
                    <div class="col-xs-6 g-text-right--xs">
                        <p class="g-font-size-14--xs g-margin-b-0--xs g-color--white-opacity-light"><a href="../#preview/Megakit/">Megakit</a> Theme Powered by: <a href="http://www.keenthemes.com/">KeenThemes.com</a></p>
                    </div>
                </div>
            </div>
            <!-- End Copyright -->
        ...
        <script type="text/javascript" src="../js/components/manual_script.js"></script>
        <!--========== END JAVASCRIPTS ==========-->
